...
const cities = {
    "alpha": {x:103, y:224, next:"beta"},
    "mu": {x:170, y:342, next:"omicron"},
    "delta": {x:175, y:285, next:"epsilon"},
    "beta": {x:130, y:264, next:"delta"},
    "gamma": {x:364, y:184, next:"kappa"},
    "omicron": {x:115, y:328, next:"theta"},
    "theta": {x:50, y:280, next:"zeta"},
    "epsilon": {x:327, y:347, next:"gamma"},
    "lambda": {x:272, y:275, next:"mu"},
    "zeta": { x:25, y:229, next:"alpha"},
    "kappa": {x:332, y:224, next:"lambda"},
};
...
function setup()
{
    ...
    animal = new PIXI.Sprite(app.loader.resources["omicron"].texture);
    //animal.x = 522;
    //animal.y = 380;
    //animal.anchor.set(0.5,1);
    animal.x = 35;
    animal.y = 35;
    animal.scale.set(1.0,1.0);
...
function preload()
{
    ...
    .add("alpha", "res/greeks/alpha.png")
    .add("mu", "res/greeks/mu.png")
    .add("delta", "res/greeks/delta.png")
    .add("beta", "res/greeks/beta.png")
    .add("gamma", "res/greeks/gamma.png")
    .add("omicron", "res/greeks/omicron.png")
    .add("theta", "res/greeks/theta.png")
    .add("epsilon", "res/greeks/epsilon.png")
    .add("lambda", "res/greeks/lambda.png")
    .add("zeta", "res/greeks/zeta.png")
    .add("kappa", "res/greeks/kappa.png")
    .load(setup);
}
